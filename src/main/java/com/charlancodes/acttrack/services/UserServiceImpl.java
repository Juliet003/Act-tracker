...
public class UserServiceImpl implements UserService {
    ...
    public void createUser(UserDto userDto) {
        Optional<User> checkIfUserExistInDb = userRepository.findUserByEmail(userDto.getEmail());
...
//    @Override
//    public List<Task> fetchInProgressTasks(Long userId, String status) {
//        User user = userRepository.findById(userId)
//                .orElseThrow(() -> new ResourceNotFoundException("User doesn't exist"));
//        return taskRepository.findTasksByUserAndTaskStatus(user, TaskStatus.valueOf(status));
//    }
